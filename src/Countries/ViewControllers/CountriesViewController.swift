...
class CountriesViewController: UITableViewController {
    ...
    @IBAction func refreshTapped(_ sender: UIBarButtonItem) {
        ...
        p.label.text = NSLocalizedString("Loading Countries", comment: "Loading Countries Title")
        
        self.countryList.refreshListFromGeonamesService(language: NSLocale.current.languageCode) { (success) -> () in
