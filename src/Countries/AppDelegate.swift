...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /**
        (en): The Primary color of the App Theme.
        
        (pt): A cor primária do tema do App.
     */
    var primaryColor = UIColor(red: 40.0/255.0, green: 91.0/255.0, blue: 149.0/255.0, alpha: 1.0)

    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        
        // (en): Appearance Customization
        // (pt): Personalização da aparência
        ...
        dict[NSAttributedStringKey.font] = UIFont(name: "HoboStd", size: 24.0)
